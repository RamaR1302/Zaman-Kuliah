...
public class listViewAdaptar extends BaseAdapter {
    ...
    private ArrayList<String> asal;
    private ArrayList<String> foto;
    private AppCompatActivity activity;



    public listViewAdaptar(ArrayList<String> id, ArrayList<String> nama, ArrayList<String> asal, ArrayList<String> foto, AppCompatActivity activity) {
        this.id = id;
        this.nama = nama;
        this.asal = asal;
        this.foto = foto;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView)convertView.findViewById(R.id.des1)).setText(String.valueOf(asal.get(position)));

...
public class DataKucing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_kucing);
        ...
        listViewContact.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent AdminEdit = new Intent(DataKucing.this, AdminEdit.class);

                AdminEdit.putExtra("id", idContact);

                startActivity(AdminEdit);
    ...
    public void tambah(View view) {
        Intent intent = new Intent(DataKucing.this, Kucing.class);

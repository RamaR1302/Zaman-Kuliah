...
public class KucingBesar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kucing_besar);
    ...
    private void uploadFoto() {
        ...
        if(filePath != null) {
            ...
            final StorageReference ref = STKoneksi.child("kucingbesar/"+imagename);
